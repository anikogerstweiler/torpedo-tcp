...
public class ShipType {
    ...
    public Ship createShip(int positionX, int posiotionY) {
        ...
        for (ShipElement element : shipElements) {
            shiftedElements.add(new ShipElement(element.getRelativePositionX() + positionX, element.getRelativePositionY() + posiotionY));
        }
    ...
    public int hashCode() {
        ...
        result = prime * result + (shipElements == null ? 0 : shipElements.hashCode());
        return result;
    }
